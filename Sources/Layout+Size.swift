...
public extension Layout where Anchors == (width: NSLayoutDimension, height: NSLayoutDimension) {
    ...
    @discardableResult
    func equal(to constant: CGFloat, priority: LayoutPriority = .required, file: StaticString = #file, line: UInt = #line) -> (width: NSLayoutConstraint, height: NSLayoutConstraint) {
        return (
    ...
    @discardableResult
    func greaterThanOrEqual(to constant: CGFloat, priority: LayoutPriority = .required, file: StaticString = #file, line: UInt = #line) -> (width: NSLayoutConstraint, height: NSLayoutConstraint) {
        return (
    ...
    @discardableResult
    func lessThanOrEqual(to constant: CGFloat, priority: LayoutPriority = .required, file: StaticString = #file, line: UInt = #line) -> (width: NSLayoutConstraint, height: NSLayoutConstraint) {
        return (
